...
public class RootProjectActivity extends Activity {
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			if (msg.obj != null) {
				...
				mAdapter = new RootProjectAdapter(RootProjectActivity.this,
						RootProjectActivity.this.allRootProjects);
				mListView.setAdapter(mAdapter);
				RootProjectActivity.this.mListView
						.setOnItemClickListener(mOnItemClickListener);
			} else {
				Toast.makeText(RootProjectActivity.this, "连接服务器失败,请稍候再试!",
	...
	private OnItemClickListener mOnItemClickListener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
				long id) {
			RootProject oneRootProject = (RootProject) mAdapter
					.getItem(position);
